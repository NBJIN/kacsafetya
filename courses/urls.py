...
urlpatterns = [
    ...
    path('all_courses/location/<str:location>/', views.all_courses_location, name='all_courses_location'),
    path('all_courses/group_by/<str:group_by>/', views.all_courses_group_by, name='all_courses_group_by'),
